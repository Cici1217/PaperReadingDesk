...
const featureTranslations = {
  zh: {
    ...
    eyebrow6: "AI ASSISTED READING", heading6: "AI 阅读笔记、高亮与提问", desc6: "AI 辅助阅读提供“笔记指南”和“三遍阅读法”两种生成方法，每次生成都会保留新版本。阅读正文时也可以选择片段，围绕原文向当前 AI 提问。",
  ...
  ja: {
    ...
    eyebrow1: "LOCAL AI", heading1: "Codex または Claude Code を接続", desc1: "ホームでCodexまたはClaude Codeのコマンドとモデルを保存・テストし、成功したCLIを現在のAIに設定します。認証情報は各CLIが管理します。",
    ...
    eyebrow6: "AI ASSISTED READING", heading6: "AI読解ノート、ハイライト、質問", desc6: "「ノートガイド」と「三段階読解法」の2方式でノートを生成し、毎回新しい版を保存します。本文を選択して現在のAIへ質問することもできます。",
  ...
  en: {
    ...
    eyebrow1: "LOCAL AI", heading1: "Connect Codex or Claude Code", desc1: "Save and test a Codex or Claude Code command and model, then select a verified CLI as the active AI. Each CLI continues to manage its own credentials.",
    ...
    eyebrow6: "AI ASSISTED READING", heading6: "AI reading notes, highlights, and questions", desc6: "Generate notes with either the notes guide or three-pass method; each run becomes a new version. Select source passages to ask the active AI focused questions while reading.",
  ...
  ko: {
    ...
    eyebrow1: "LOCAL AI", heading1: "Codex 또는 Claude Code 연결", desc1: "홈에서 Codex 또는 Claude Code 명령과 모델을 저장하고 테스트한 뒤 성공한 CLI를 현재 AI로 설정합니다. 인증 정보는 각 CLI가 관리합니다.",
    ...
    eyebrow6: "AI ASSISTED READING", heading6: "AI 읽기 노트, 하이라이트, 질문", desc6: "노트 가이드와 3단계 읽기법 두 방식으로 생성하며 매번 새 버전을 보존합니다. 본문을 선택해 현재 AI에 질문할 수도 있습니다.",
